...
public partial class DatabaseScaffolderPrivateMethodTests
{
    ...
    [InlineData("DATE '2026-06-15'")]
    [InlineData("TIME '12:34:56'")]
    [InlineData("TIME WITH TIME ZONE '12:34:56+02:00'")]
    [InlineData("TIMESTAMP '2026-06-15 12:34:56'")]
    [InlineData("TIMESTAMP WITH TIME ZONE '2026-06-15 12:34:56+02:00'")]
    [InlineData("INTERVAL '1 hour 30 minutes'")]
    [InlineData("x''")]
    ...
    [InlineData("B'1012'")]
    [InlineData("B''")]
    [InlineData("B'1010'; DROP TABLE Users")]
    [InlineData("DATE '2026-00-15'")]
    [InlineData("TIME '25:00:00'")]
    [InlineData("TIMESTAMP '2026-06-15 12:34:56'; DROP TABLE Users")]
    [InlineData("INTERVAL '1 fortnight'")]
    [InlineData("INTERVAL '1 hour'; DROP TABLE Users")]
