...
public partial class ScaffoldingContractDocTests
{
    ...
    public void Docs_and_gate_pin_recent_scaffold_hardening_scope()
    {
        ...
        var featureMapBuilderSource = string.Concat(
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureMapBuilder.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureMapBuilder.Details.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureMapBuilder.Names.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureMapBuilder.Precision.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureMapBuilder.WriteBlocking.cs"));
        ...
        Assert.Contains("self-referencing one-to-many", doc, StringComparison.Ordinal);
        ...
        Assert.Contains("ScaffoldAsync_generates_self_referencing_one_to_many_on_live_provider", liveScaffoldTests, StringComparison.Ordinal);
        ...
        Assert.Contains("ScaffoldAsync_dry_run_does_not_create_output_directory_on_live_provider", liveScaffoldTests, StringComparison.Ordinal);
        Assert.Contains("ScaffoldAsync_no_overwrite_preflights_existing_files_on_live_provider", liveScaffoldTests, StringComparison.Ordinal);
        ...
        Assert.Contains("Dotnet_norm_scaffold_preserves_database_comments_as_xml_docs_on_live_provider", liveScaffoldCliTests, StringComparison.Ordinal);
        ...
        Assert.Contains("ScaffoldAsync_fail_on_warnings_writes_diagnostics_then_throws_on_live_provider", liveScaffoldTests, StringComparison.Ordinal);
        ...
        Assert.Contains("`msbuildProjectExtensionsPath`, `noBuild`, `json`", doc, StringComparison.Ordinal);
        ...
        Assert.Contains("SQL Server provider-native temporal table diagnostics are verified through the real CLI", doc, StringComparison.Ordinal);
        Assert.Contains("Dotnet_norm_scaffold_reports_sqlserver_native_temporal_tables_and_marks_them_read_only", liveScaffoldCliTests, StringComparison.Ordinal);
        ...
        Assert.Contains("Self-referencing FKs are verified as role-named", doc, StringComparison.Ordinal);
        Assert.Contains("one-to-many relationships through the real CLI path", doc, StringComparison.Ordinal);
        ...
        Assert.Contains("DATE '2026-06-15'", doc, StringComparison.Ordinal);
        Assert.Contains("INTERVAL '1 hour'", doc, StringComparison.Ordinal);
        ...
        Assert.Contains("TypedTemporalLiteralPattern", defaultValidator, StringComparison.Ordinal);
        Assert.Contains("IntervalLiteralPattern", defaultValidator, StringComparison.Ordinal);
