...
/// <summary>
/// MG-1: Verifies that GetAppliedMigrationsAsync handles the "history table does not exist"
...
public class MigrationHistoryFaultTests
{
    ...
    /// <summary>
    /// MG-1: When the migrations history table does not yet exist, GetAppliedMigrationsAsync
    ...
    /// <summary>
    /// MG-1: When a transient DbException occurs (e.g., permission denied, connection reset)
    ...
    public async Task GetAppliedMigrations_WhenTransientDbException_Propagates()
    {
        ...
        Assert.True(conn.FaultCount >= 1,
            "MG-1: The fault-injecting connection should have been called at least once.");
    }

    /// <summary>
    /// MG-1: After the history table has been created and a migration recorded,
    ...
    /// <summary>
    /// MG-1: HasPendingMigrationsAsync must also propagate transient DbExceptions from
