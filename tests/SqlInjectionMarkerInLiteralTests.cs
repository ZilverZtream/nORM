...
/// <summary>
/// SEC-1: Verifies that CountParameterMarkers uses a mini SQL lexer so that
...
{
    // ─── SEC-1: '@' inside email literal must NOT suppress injection check ─────

    [Fact]
    public void EmailInLiteral_NoRealParams_InjectionCheckFires()
    {
        // SEC-1 core case: '@' is inside 'user@example.com' — a string literal.
    ...
    // ─── SEC-1: Real @param marker outside literals must still be counted ─────
    ...
    // ─── SEC-1: Literal '@' + real @param both present — marker counted ───────
    ...
    // ─── SEC-1: '@' inside line comment must NOT be counted ───────────────────
    ...
    // ─── SEC-1: '@' inside block comment must NOT be counted ──────────────────
