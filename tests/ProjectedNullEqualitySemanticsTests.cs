...
namespace nORM.Tests
{
    ...
    public sealed class ProjectedNullEqualitySemanticsTests
    {
        ...
        {
            new Row { Id = 1, A = 1,    B = 1,    S1 = "x",  S2 = "x"  },  // both equal, non-null
            new Row { Id = 2, A = 2,    B = null, S1 = "y",  S2 = null },  // right null
            new Row { Id = 3, A = null, B = 2,    S1 = null, S2 = "z"  },  // left null
            new Row { Id = 4, A = null, B = null, S1 = null, S2 = null },  // both null
            new Row { Id = 5, A = 3,    B = 2,    S1 = "p",  S2 = "q"  },  // both non-null, differ
        };
        ...
        private static async Task<DbContext> NewContextAsync()
        {
            ...
            {
                cmd.CommandText = "CREATE TABLE NullEqRow (Id INTEGER PRIMARY KEY, A INTEGER NULL, B INTEGER NULL, S1 TEXT NULL, S2 TEXT NULL)";
                cmd.ExecuteNonQuery();
            }
