...
public partial class ScaffoldingContractDocTests
{
    ...
    private static string ReadForeignKeyDiscoverySource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldForeignKeyDiscovery.Sqlite.Query.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldForeignKeyDiscovery.Sqlite.Rows.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldForeignKeyDiscovery.Sqlite.Semantics.cs"),
    ...
    private static string ReadManyToManyDiscoverySource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldManyToManyJoinDiscovery.Build.cs"),
    ...
    private static string ReadPostgresUnsupportedFeatureSource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldPostgresProviderSpecificIndexFeatureDiscovery.BtreeOptions.Details.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldPostgresProviderSpecificIndexFeatureDiscovery.BtreeOptions.Filter.cs"));
    ...
    private static string ReadSkippedObjectDiscoverySource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Procedures.Parameters.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Procedures.Results.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Procedures.Filters.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Functions.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Functions.Parameters.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Functions.Results.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldSqlServerSkippedObjectDiscovery.Sql.Functions.Filters.cs"),
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldPostgresSkippedObjectDiscovery.Sql.Routines.Parameters.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldPostgresSkippedObjectDiscovery.Sql.Routines.Shape.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldPostgresSkippedObjectDiscovery.Sql.Routines.Filters.cs"),
    ...
    private static string ReadDiagnosticsWriterSource()
        => string.Concat(
            ...
            ReadSuggestedActionSource(),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.Markdown.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.Markdown.Features.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.Markdown.Objects.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.Markdown.Relationships.cs"),
    ...
    private static string ReadSuggestedActionSource()
        => string.Concat(
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.SuggestedActions.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.SuggestedActions.Indexes.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.SuggestedActions.Objects.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.SuggestedActions.Relationships.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldDiagnosticsWriter.SuggestedActions.Scalar.cs"));
    ...
    private static string ReadRoutineStubWriterSource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldRoutineStubWriter.Plan.Model.cs"),
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFunctionRoutineStubWriter.Streaming.Generic.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFunctionRoutineStubWriter.Streaming.Typed.cs"),
    ...
    private static string ReadContextWriterSource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldContextWriter.ModelConfiguration.Defaults.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldContextWriter.ModelConfiguration.IdentityPrecision.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldContextWriter.ModelConfiguration.Facets.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldContextWriter.ModelConfiguration.ComputedCollation.cs"),
    ...
    private static string ReadStaticEntityScaffoldSource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldModelComposition.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldModelCompositionBuilder.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldModelCompositionBuilder.Configurations.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldModelCompositionBuilder.GeneratedDiagnostics.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldModelCompositionBuilder.Relationships.cs"),
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureConfigurationAdapter.Conversions.Relational.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "ScaffoldFeatureConfigurationAdapter.Conversions.Scalar.cs"),
    ...
    private static string ReadDynamicEntitySource()
        => string.Concat(
            ...
            ReadRepoFile("src", "nORM", "Scaffolding", "DynamicEntityTypeGenerator.Schema.Facets.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "DynamicEntityTypeGenerator.Schema.ProviderTypes.cs"),
            ReadRepoFile("src", "nORM", "Scaffolding", "DynamicEntityTypeGenerator.Schema.Resolve.cs"),
