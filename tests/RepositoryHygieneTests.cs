...
public sealed class RepositoryHygieneTests
{
    ...
    private const int MaxLiveProviderScaffoldCliFileLines = 640;
    ...
    public void Live_provider_scaffold_tests_stay_split_by_scenario_group()
    {
        ...
        Assert.Contains("Live-provider CLI scaffold test files stay below 640 lines", ownership, StringComparison.Ordinal);
