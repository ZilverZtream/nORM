...
public sealed class RepositoryHygieneTests
{
    ...
    private const int MaxLiveProviderScaffoldCliFileLines = 620;
    ...
    public void Live_provider_scaffold_tests_stay_split_by_scenario_group()
    {
        ...
        Assert.Contains("Live-provider CLI scaffold test files stay below 620 lines", ownership, StringComparison.Ordinal);
