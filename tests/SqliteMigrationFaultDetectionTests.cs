...
/// <summary>
/// Unit tests for SqliteMigrationRunner.IsTableNotFoundError.
...
public class SqliteMigrationFaultDetectionTests
{
 ...
 /// <summary>
 /// SqliteException with code 1 and "no such table" message → true.
 ...
 /// <summary>
 /// SqliteException with code 1 but a different message (syntax error) → false.
 ...
 /// <summary>
 /// SqliteException with "no such table" in the message but a non-1 error code → false.
 ...
 /// <summary>
 /// A generic (non-Sqlite) DbException with "no such table" in the message → true.
 ...
 /// <summary>
 /// A generic (non-Sqlite) DbException without matching message → false.
 /// </summary>
    [Fact]
