...
/// <summary>
/// QP-1: Verifies that _simpleSqlCache uses a stable per-fingerprint string key.
///
...
public class SimpleSqlCacheCollisionTests
{
    ...
    /// <summary>
    /// QP-1 regression: two Where predicates on different columns of the same entity type
    ...
    /// <summary>
    /// QP-1 regression: Count queries with structurally different predicates must
