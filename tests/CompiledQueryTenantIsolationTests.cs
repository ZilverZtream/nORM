...
public class CompiledQueryTenantIsolationTests
{
 ...
 //<summary>
 //After the plan for tenant-1 is cached, a subsequent call using tenant-2
 ...
 //<summary>
 //Two contexts with the same provider+mapping but different global filters
 ...
 //<summary>
 //Smoke test — a context with TenantProvider set must not throw when using
