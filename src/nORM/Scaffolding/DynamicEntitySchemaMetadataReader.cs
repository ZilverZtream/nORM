...
namespace nORM.Scaffolding
{
    internal static class DynamicEntitySchemaMetadataReader
    {
        ...
        private static IReadOnlyDictionary<string, ScaffoldColumnFacet> QueryColumnFacetMap(
        ...
        private static IReadOnlyDictionary<string, ScaffoldDecimalPrecisionInfo> QueryDecimalPrecisionMap(DbConnection connection, string sql, string? schemaName, string tableName)
        {
