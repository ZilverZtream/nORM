...
namespace nORM.Scaffolding
{
    ...
    internal static class ScaffoldRoutineStubWriter
    {
        ...
        private static string FormatProviderEscapedRoutineName(ScaffoldRoutineStubInfo routine)
        {
        ...
        private static string QualifiedRoutineName(ScaffoldRoutineStubInfo routine)
        ...
        private static string FormatStoredProcedureParameterArgument(ScaffoldRoutineStubInfo routine, int expectedInputParameterCount)
        {
        ...
        private static string FormatRoutineArgumentArray(string? parameterType, IReadOnlyList<RoutineStubParameter> inputParameters, bool usePositionalArguments = false, bool useNullableReferenceTypes = true)
        {
