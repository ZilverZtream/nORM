...
namespace nORM.Mapping
{
    ...
    public sealed class Column
    {
        ...
        /// <summary>
        /// True for a single-column integer primary key that takes the store-generated-key CONVENTION
        /// (EF Core parity) — no explicit value-generation config. Distinct from <see cref="IsDbGenerated"/>:
        /// a convention key is store-generated only when its value is DEFAULT (0); a non-default value is
        /// honored on INSERT. The write path reads this per-entity (see honor_nonzero_key_convention_plan).
        /// </summary>
        public bool IsConventionGeneratedKey { get; private set; }
        /// <summary>
        ...
        /// <summary>
        /// Marks this column as a store-generated-key CONVENTION column (EF Core parity): store-generated when
        /// its value is default, honored when non-default. Applied by <see cref="TableMapping"/> to the sole
        /// integer primary key when value generation was not configured explicitly.
        /// </summary>
        internal void MarkConventionGeneratedKey() => IsConventionGeneratedKey = true;
