...
| 40 | Run and publish a real RC release gate | Verified | `eng/v1-release-gate.ps1 -Mode rc -MinLiveProviders 3 -SkipBenchmark` passed on commit `8f4aae0` against SQL Server, PostgreSQL, and MySQL (all 3 live providers): AOT 231/231 clean, public API snapshot ✓, package consumer ✓, CLI smoke ✓, live provider gate 1191/1191, full suite 9671/9671 × 2 passes, nav/tx/compiled stress 20×26+20×55+20×26 all clean, source-gen parity 97/97, bulk/provider parity 424/424, migration gate 215/215, cache bounds 16/16, adversarial 767/767. RC artifact manifest written to `artifacts/v1-rc`. |
