...
| 40 | Run and publish a real RC release gate | Verified | `eng/v1-release-gate.ps1 -Mode rc -MinLiveProviders 3 -StressIterations 20 -SkipBenchmark` passed on commit `0bdf8ecdeaa09a66d1e08371ced10b3405ed59a3` against SQL Server, PostgreSQL, and MySQL with all RC correctness steps green: AOT 231/231 clean, public API snapshot 2/2, package consumer 6/6, CLI smoke 10/10, live provider gate 1347/1347 plus second pass 1347/1347, full suite 9872/9872 plus second pass 9872/9872, navigation/transaction/compiled-query stress 20x each, source-gen parity 97/97, bulk/provider parity 424/424, migration gate 215/215, cache bounds 16/16, adversarial 767/767. The generated `artifacts/v1-rc/rc-artifacts.md` manifest records the exact gate commit, package hashes, configured providers, and `-SkipBenchmark` caveat. Focused provider-sliced benchmark budgets are green; see `docs/rc2-performance-slice-status.md`. |
