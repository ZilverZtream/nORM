...
| 40 | Run and publish a real RC release gate | Verified | `eng/v1-release-gate.ps1 -Mode rc -MinLiveProviders 3 -StressIterations 20` passed on commit `4e162f0afb30526cc35b091ebe3c13d9af371271` against SQL Server, PostgreSQL, and MySQL with benchmarks enabled and all RC steps green: AOT 231/231 clean, public API snapshot 2/2, package consumer 6/6, CLI smoke 10/10, live provider gate 1347/1347 plus second pass 1347/1347, full suite 9873/9873 plus second pass 9873/9873, navigation/transaction/compiled-query stress 20x each, source-gen parity 97/97, bulk/provider parity 424/424, migration gate 215/215, cache bounds 16/16, adversarial 767/767, provider-sliced benchmark threshold gate passed. The generated `artifacts/v1-rc/rc-artifacts.md` manifest records the exact gate commit, package hashes, configured providers, and `Benchmark skipped: False`. Final provider-sliced benchmark budgets are green; see `docs/rc2-performance-slice-status.md`. |
