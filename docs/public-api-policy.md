...
| `nORM.Scaffolding.ScaffoldOptions.Tables` / `nORM.Scaffolding.ScaffoldOptions.Schemas` | Stable - scaffold selection filters | `DatabaseScaffolderOutputFilterTests`, `LiveProviderScaffoldingFilterTests`, `LiveProviderScaffoldCliSchemaFilterTests` | `docs/scaffolding.md`, `src/dotnet-norm/README.md`, `README.md` |
...
| `nORM.Scaffolding.ScaffoldOptions.EmitViewEntities` / `nORM.Scaffolding.ScaffoldOptions.EmitQueryArtifacts` | Stable - scaffold query-artifact opt-ins | `DatabaseScaffolderDiagnosticsTests`, `DatabaseScaffolderOutputFilterTests`, `LiveProviderScaffoldingQueryArtifactTests`, `LiveProviderScaffoldCliQueryArtifactTests` | `docs/scaffolding.md`, `src/dotnet-norm/README.md`, `README.md` |
