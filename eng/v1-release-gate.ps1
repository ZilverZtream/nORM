...
$liveFilter = 'FullyQualifiedName~LiveProviderIntegrationTests|FullyQualifiedName~LiveCrossProviderTests|FullyQualifiedName~LiveProviderSavepointMigrationTests|FullyQualifiedName~SqlServerMigrationRunnerTests.Live|FullyQualifiedName~PostgresMigrationRunnerTests.Live|FullyQualifiedName~BulkTransactionAtomicityTests.Postgres_BulkUpdate_BatchFailure_RollsBackEarlierBatches_Live|FullyQualifiedName~BulkTempTableLeakTests.SqlServer|FullyQualifiedName~PostgresBulkDuplicateTests'
