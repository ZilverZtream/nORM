...
single-column/composite index metadata including descending key order and SQL
Server/PostgreSQL included-column index metadata are supported, including
columns that participate in multiple indexes. SQL Server
